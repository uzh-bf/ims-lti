...
describe('LTI.Extensions.Content', function() {
  ...
  describe('_validate_return_type', () => it('should throw an exception if the type does not exist for the provider', function() {
    const fn = () => {
  ...
  describe('has_return_type', () => it('should be able to check if a return type is set', function() {
  ...
  describe('has_file_extension', () => it('should be able to check if a file extension is set', function() {
  ...
  return describe('redirector', () => it('should be overridable', function() {
    let test_res = null;
    let test_url = null;
